...
const ImportModal = ({ onClose, onImportComplete })=>{
    ...
    const { fetchStudents } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStudentContext"])(); // Access fetchStudents from context
    const handleDrag = (e)=>{
        e.preventDefault();
        e.stopPropagation();
...
//# sourceMappingURL=_db61bba4._.js.map