                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "space-y-3",
                                                                    children: company.total_eligible === -1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        onClick: ()=>{
                                                                            setSelectedCompanyForEligibility(company);
                                                                            setShowEligibilityModal(true);
                                                                        },
...
{
const e = new Error("Could not parse module '[project]/app/company-listing/CompanyFormModal.js'\n\nUnexpected token. Did you mean `{'}'}` or `&rbrace;`?");
...
function ManualOverrideModal({ student, companyId, batchYear, onClose, onSuccess }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setSubmitting(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/eligibility/manual/${companyId}/${batchYear}/students/${student.id}`, {
                action: "add",
                reason: reason.trim()
            });
...
function EligibleStudentsManager({ companyId, batchYear, onClose }) {
    ...
    const fetchEligibilityBrief = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/eligibility/${companyId}/${batchYear}`);
            setBriefInfo(data);
        } catch (err) {
    ...
    const fetchEligibilityDetails = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/eligibility/${companyId}/${batchYear}/details`);
    ...
    const handleCalculateEligibility = async ()=>{
        try {
            setCalculating(true);
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://localhost:5000/eligibility/${companyId}/${batchYear}/calculate`);
    ...
    const handleAddViaDreamCompany = async (studentId)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/eligibility/${companyId}/${batchYear}/students/${studentId}`, {
                action: "add"
            });
    ...
    const handleRemoveFromEligible = async (studentId, isManualOverride)=>{
        try {
            ...
            if (isManualOverride) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/eligibility/manual/${companyId}/${batchYear}/students/${studentId}`, {
                    action: "remove"
                });
            } else {
...
//# sourceMappingURL=_a9c548f5._.js.map