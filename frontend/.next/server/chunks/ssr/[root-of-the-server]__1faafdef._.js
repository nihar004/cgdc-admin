...
function CompaniesProvider({ children }) {
    ...
    const fetchCompanies = async ()=>{
        try {
            setLoading(true);
            const response = await axios.get(`http://localhost:5000/companies/batch/${selectedBatch}`);
...
function CompanyTableView({ statusColors, companyTypeColors, selectedBatch = 2 }) {
    const { formatPackage, setSelectedCompany, companies, fetchCompanies, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CompaniesContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCompaniesContext"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1faafdef._.js.map