...
function StudentTable({ filteredStudents }) {
    const { formatStudentName, setEditingStudent, setStudentFormData, setShowEditStudentModal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStudentContext"])();
    ...
    const handleConfirmDelete = async ()=>{
        ...
        try {
            ...
            alert(`Student ${studentToDelete.first_name} ${studentToDelete.last_name} has been deleted successfully.`);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__78385899._.js.map