...
const EmailProvider = (param)=>{
    ...
    const fetchCampaigns = async ()=>{
        try {
            const response = await fetch("".concat(API_BASE, "/emails/email-logs?page=1&limit=50"), {
                credentials: "include"
            });
            const data = await response.json();
            if (data.success) {
    ...
    const createTemplate = async (formData)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/emails/email-templates", formData, {
                headers: {
    ...
    const updateTemplate = async (id, formData)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("".concat(API_BASE, "/emails/email-templates/").concat(id), formData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                },
                withCredentials: true
    ...
    const sendCampaign = async (campaignData)=>{
        ...
        try {
            ...
            const response = await fetch("".concat(API_BASE, "/emails/email-logs/send"), {
                method: "POST",
                headers: isFormData ? {} : {
    ...
    const previewEmail = async (payload)=>{
        try {
            const response = await fetch("".concat(API_BASE, "/emails/email-logs/preview"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const deleteCampaign = async (id)=>{
        try {
            const response = await fetch("".concat(API_BASE, "/emails/email-logs/").concat(id), {
                method: "DELETE",
                credentials: "include"
            });
            const data = await response.json();
...
const ComposeEmail = ()=>{
    _s();
    const { templates, sendCampaign, previewEmail, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$EmailContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmail"])();
    ...
    const handleFileSelect = (e)=>{
        ...
        const validFiles = files.filter((file)=>{
            if (file.size > 10 * 1024 * 1024) {
                alert("".concat(file.name, " is too large. Max size is 10MB"));
                return false;
            }
            return true;
        });
    ...
    const getAttachmentCount = ()=>{
        if (!(selectedTemplate === null || selectedTemplate === void 0 ? void 0 : selectedTemplate.attachments)) return 0;
        try {
            const attachments = typeof selectedTemplate.attachments === "string" ? JSON.parse(selectedTemplate.attachments) : selectedTemplate.attachments;
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        getAttachmentCount() > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                previewData.attachments && previewData.attachments.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-sm font-semibold text-gray-600 mb-2",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: previewData.attachments.map((attachment, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ComposeEmail, "NQe17tfypcUmNplJGul+s47GYBY=", false, function() {
    return [
...
_s(Templates, "+wFz7CDUzJNLkT4CzHcCX69uw/4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$EmailContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmail"]
    ];
});
...
(()=>{
    const e = new Error("Cannot find module './CampaignHistory'");
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            activeTab === "history" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CampaignHistory, {}, void 0, false, {
                                fileName: "[project]/app/email-management/page.js",
                                lineNumber: 73,
                                columnNumber: 41
                            }, ("TURBOPACK compile-time value", void 0))
...
//# sourceMappingURL=_115b8690._.js.map