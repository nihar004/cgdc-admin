    ...
    const handleSubmit = async (e)=>{
        ...
        if (isValid) {
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("".concat(type === "company" ? "Company" : "Position", " deleted successfully"));
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to del  ete ".concat(type));
            }
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please type the confirmation text correctly");
        }
    };
...
"[project]/app/company-listing/EmailTargetModal.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EmailTargetModal(param) {
    let { company, onClose, onSelect } = param;
    _s();
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const handleSelect = async (type)=>{
        try {
            setLoading(true);
            const endpoint = type === "eligible" ? "/eligibility/companies/".concat(company.id, "/batch/").concat(company.batch_year, "/email-targets/eligible-only") : "/eligibility/companies/".concat(company.id, "/batch/").concat(company.batch_year, "/email-targets/dream-only");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("".concat(backendUrl).concat(endpoint));
            if (response.data.success) {
                // Check if there are students
                if (response.data.total_count === 0) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("No students found in selected group");
                    return;
                }
                const emailData = {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to get eligible students");
            }
        } catch (error) {
...
_s(EmailTargetModal, "/Rjh5rPqCCqf0XYnTUk9ZNavw3Q=");
_c = EmailTargetModal;
var _c;
__turbopack_context__.k.register(_c, "EmailTargetModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
            ...
            selectedColumnKeys.forEach((key)=>{
                switch(key){
                    ...
                    case "package_ranges":
                        ...
                        row[key] = ((_company_positions4 = company.positions) === null || _company_positions4 === void 0 ? void 0 : _company_positions4.map((p)=>{
                            if (p.package === -1) return "Not Disclosed";
                            if (p.has_range) {
                                return "₹".concat(p.package, "L - ₹").concat(p.package_end, "L");
                            }
                            return "₹".concat(p.package, "L");
                        }).join(", ")) || "N/A";
                        break;
                    ...
                    case "eligibility_12th":
                        row[key] = company[key] ? "".concat(parseFloat(company[key]), "%") : "N/A";
                        break;
                    case "jd_shared_date":
                        row[key] = company[key] ? new Date(company[key]).toLocaleDateString() : "N/A";
                        break;
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: searchTerm || sectorFilter !== "all" || specializationFilter !== "all" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    !searchTerm && sectorFilter === "all" && specializationFilter === "all" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    (searchTerm || sectorFilter !== "all" || specializationFilter !== "all") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CompanyListing, "ebrosa9zVCrRJQLadWZjAJyfGLI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CompaniesContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCompaniesContext"]
    ];
});
...
//# sourceMappingURL=app_company-listing_0123bf1e._.js.map