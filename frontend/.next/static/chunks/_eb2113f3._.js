...
function EditStudentModel() {
    _s();
    const { showEditStudentModal, setShowEditStudentModal, setEditingStudent, studentFormData, editingStudent, setStudentFormData, setStudents } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudentContext"])();
...
_s(EditStudentModel, "N08+Y8TdFZ52k1TyCVSAqCGnzMY=", false, function() {
    return [
...
function StudentTable(param) {
    ...
    const handleConfirmDelete = async ()=>{
        ...
        setIsDeleting(true);
        try {
            await axios.delete("http://localhost:5000/students/".concat(studentToDelete.id));
            ...
            alert("Student ".concat(studentToDelete.first_name, " ").concat(studentToDelete.last_name, " has been deleted successfully."));
        } catch (error) {
...
_s(StudentTable, "IWdfNSU+k20DSAX6WlGACajt3ps=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudentContext"]
    ];
});
...
_s(UpdateModal, "TG/HQvgz63qK2vHgWOrTWqwaDcg=");
_c = UpdateModal;
...
//# sourceMappingURL=_eb2113f3._.js.map