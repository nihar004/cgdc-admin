...
function UserManagement() {
    ...
    const fetchUsers = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("".concat(backendUrl, "/users"), {
    ...
    const handleUpdateUser = async (userId, updates)=>{
        try {
            setError("");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("".concat(backendUrl, "/users/").concat(userId), updates, {
                withCredentials: true
            });
    ...
    const handleDeleteUser = async (userId, username)=>{
        ...
        try {
            setError("");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("".concat(backendUrl, "/users/").concat(userId), {
                withCredentials: true
            });
            if (response.data.success) {
