...
const StudentProvider = (param)=>{
    ...
    const fetchStudents = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error fetching students data");
...
_s(StudentProvider, "plDdVEdifU29HAYDSJ2ui1Mz/O8=");
_c = StudentProvider;
...
function EditStudentModel() {
    ...
    const handleUpdateStudent = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("http://localhost:5000/students/update/".concat(editingStudent.id), studentToUpdate);
...
function StudentTable(param) {
    ...
    const handleConfirmDelete = async ()=>{
        ...
        setIsDeleting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("http://localhost:5000/students/".concat(studentToDelete.id));
...
_s(StudentTable, "/lTibm2COKN5D74zMVNqwZ+NCdU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudentContext"]
    ];
});
...
const ImportModal = (param)=>{
    ...
    const { fetchStudents } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudentContext"])(); // Access fetchStudents from context
    const handleDrag = (e)=>{
        e.preventDefault();
        e.stopPropagation();
...
const UpdateModal = (param)=>{
    ...
    const handleUpdate = async ()=>{
        ...
        formData.append("file", file);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("http://localhost:5000/students/bulk-update", formData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
            });
...
_s(StudentManagementContent, "bXj9u6omyqjX1DfC8XzHN2YD3Z4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$StudentContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudentContext"],
...
//# sourceMappingURL=_f6c99de2._.js.map